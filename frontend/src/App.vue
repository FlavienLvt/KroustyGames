    ...
    <div class="main-wrapper">
      <header class="topbar">
        <div class="search-container">
          ...
          <input type="text" placeholder="Rechercher des jeux et des catégories..." class="search-bar" />
        </div>
...
<style>
/* Variables globales (Sans le mot 'scoped' pour s'appliquer partout) */
