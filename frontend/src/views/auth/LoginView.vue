...
<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-900 px-4">
    <div class="max-w-md w-full bg-gray-800 p-8 rounded-lg shadow-lg border border-gray-700">
      <h2 class="text-3xl font-extrabold text-center text-white mb-8">Connexion <span class="text-orange-500">KroustyGames</span></h2>
      ...
      <div class="mt-6 text-center text-sm text-gray-400">
        ...
        <router-link :to="{ name: 'register' }" class="font-medium text-orange-500 hover:text-orange-400">
          Inscrivez-vous ici
        </router-link>
      </div>
    </div>
